...
namespace SZ\ProductTypeExtension\Service;
...
class ProductTypeKeywordsSyncService
{
    ...
    */
    public function syncForIds(array $ids): void
    {
        $extensionIdsBinary = $this->normalizeIdsToBinary($ids);
        ...
        $rows = $this->connection->fetchAllAssociative(
            ...
            ['ids' => $extensionIdsBinary, 'liveVersion' => $this->liveVersionBytes],
    ...
    // Initial fill: call this once after plugin activate
